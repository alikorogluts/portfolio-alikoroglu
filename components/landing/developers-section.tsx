...
const features = [
  { 
    title: "Education", 
    description: "B.Sc. Computer Engineering, Artvin Coruh University, 2022 - Present."
  },
  { 
    title: "Training", 
    description: "ASP.NET Core, C#, and Python programming through Udemy and BTK Akademi."
  },
  { 
    title: "Interests", 
    description: "Distributed systems, backend architecture, machine learning, and computer vision."
  },
  { 
    title: "Languages", 
    description: "Turkish native; English B1 with technical reading proficiency."
  },
];
