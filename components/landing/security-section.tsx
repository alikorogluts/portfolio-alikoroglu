...
const certifications = ["Clean Architecture", "N-Tier", "REST API", "Atomic Design"];
        ...
        <div className="mb-20">
          ...
          <div className={`transition-all duration-1000 delay-100 ${
            ...
            <p className="text-xl text-muted-foreground leading-relaxed max-w-2xl">
              Ali focuses on maintainable backend boundaries, asynchronous workflows, real-time feedback, and production-ready delivery.
            </p>
          </div>
        </div>
        ...
        <div className="grid lg:grid-cols-12 gap-6">
          ...
          <div className={`lg:col-span-7 relative p-8 lg:p-12 border border-foreground/10 min-h-[400px] overflow-hidden transition-all duration-700 ${
            ...
            <div className="relative z-10">
              <span className="font-mono text-sm text-muted-foreground">Engineering principles</span>
              <div className="mt-8">
                <span className="text-7xl lg:text-8xl font-display">4</span>
                <span className="block text-muted-foreground mt-2">architecture patterns in active use</span>
              </div>
            </div>
