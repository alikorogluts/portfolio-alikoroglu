      ...
      >
        ...
        >
          ...
          <a href="#" className="flex items-center group">
            <span className={`font-display tracking-tight transition-all duration-500 ${isScrolled ? "text-xl text-foreground" : "text-2xl text-white"}`}>Ali Koroglu</span>
          </a>
          ...
          <div className="hidden md:flex items-center gap-4">
            ...
            <Button
              ...
              className={`rounded-full border transition-all duration-500 ${
                isScrolled
                  ? "bg-foreground/[0.04] hover:bg-foreground/[0.08] border-foreground/15 text-foreground px-4 h-8 text-xs"
