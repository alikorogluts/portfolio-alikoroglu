      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
          ...
          <div className="grid lg:grid-cols-12 gap-8 items-end">
            ...
            <div className="lg:col-span-5 lg:pb-4">
              <p className={`text-xl text-muted-foreground leading-relaxed transition-all duration-1000 delay-200 ${
                ...
                A practical stack across backend architecture, typed interfaces, real-time systems, mobile apps, and Python ML pipelines.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="grid lg:grid-cols-12 gap-4 lg:gap-6">
          ...
          >
            ...
            <div className="relative flex-1 p-8 lg:p-12 bg-black">
              ...
              <div className="relative z-10">
                <span className="font-mono text-sm text-muted-foreground">{strengths[0].number}</span>
                ...
                <div>
                  <span className="text-5xl lg:text-6xl font-display">{strengths[0].stats.value}</span>
                  <span className="block text-sm text-muted-foreground font-mono mt-2">{strengths[0].stats.label}</span>
                </div>
              </div>
            </div>
          ...
          <div className="lg:col-span-12 grid md:grid-cols-3 gap-4 lg:gap-6">
            {strengths.slice(1).map((feature) => (
              <div key={feature.title} className="border border-foreground/10 bg-foreground/[0.02] p-8 lg:p-10">
